// Полный список субъектов Российской Федерации (актуальный на 2024 год)
...
export const REGIONS: Region[] = [
  ...
  { id: 'orel', name: 'Орловская область', federalDistrict: 'Центральный' },
  ...
  { id: 'leningrad', name: 'Ленинградская область', federalDistrict: 'Северо-Западный' },
  ...
  { id: 'kbr', name: 'Кабардино-Балкарская Республика', federalDistrict: 'Северо-Кавказский' },
  { id: 'kchr', name: 'Карачаево-Черкесская Республика', federalDistrict: 'Северо-Кавказский' },
  ...
  { id: 'hmao', name: 'Ханты-Мансийский автономный округ — Югра', federalDistrict: 'Уральский' },
  { id: 'yanao', name: 'Ямало-Ненецкий автономный округ', federalDistrict: 'Уральский' },
  ...
  { id: 'tyva', name: 'Республика Тыва', federalDistrict: 'Сибирский' },
  ...
  { id: 'eao', name: 'Еврейская автономная область', federalDistrict: 'Дальневосточный' },
...
export const getRegionsByDistrict = (district: string): Region[] => {
  return REGIONS.filter((r) => r.federalDistrict === district);
};
